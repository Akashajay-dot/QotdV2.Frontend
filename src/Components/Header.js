              ...
              <div className="drawerInner">
                ...
                <div className="proOpt">
                  <div className="options">
                    ...
                    <div className="innerOpt">
                      <LeaderboardIcon />
                      <Link to="/leaderBoard" className="navlinks">
                        LeaderBoard
                      </Link>
                    </div>
                    <div className="innerOpt">
                      <PostAddIcon />
                      <Link to="postQuestions" className="navlinks">
                        Add Questions
                      </Link>
                    </div>
                    <div className="innerOpt">
                      <FindInPageIcon />
                      <Link to="prevQuestions" className="navlinks">
                        {" "}
                        Previous Questions
                      </Link>
                    </div>
                    ...
                    {state.isAdmin && (
                      <div className="innerOpt">
                        <AddTaskIcon />{" "}
                        <Link to="/questions" className="navlinks">
                          Approve Questions
                        </Link>
                      </div>
                    )}
